        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6">
          ...
          <ol className="space-y-4 text-sm text-gray-700">
            ...
            <li className="flex gap-3">
              ...
              <div>
                <p className="font-medium text-gray-900">Earn from purchases</p>
                <p className="text-gray-500">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div>
            ...
            <p className="text-sm text-gray-500">
              ...
              <span className="font-medium text-gray-900">&euro;250</span> or{" "}
              <span className="font-medium text-gray-900">&euro;500</span>.
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              A{" "}
              <span className="font-medium text-gray-900">15% platform fee</span>{" "}
